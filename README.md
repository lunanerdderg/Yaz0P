...
Forked from [Cuyler36](https://github.com/Cuyler36)'s [Yaz0Decoder](https://github.com/Cuyler36/Yaz0Decoder). Technically all of this Python code was written by me, but most of it is just translated directly from Cuyler's C# code with no changes.
